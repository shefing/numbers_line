...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
     ...
     yepnope(
     {
       load: [
        ...
        '../../dist/en/edgy.tetris.js?cacheElliminator'
       ],
     });
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${btnFeedbackRestart}", "click", function(sym, e) {
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-5434671");