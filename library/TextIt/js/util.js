...
var util = {
  ...
  onClick: function (elems, func) {
    util.bindEvent(elems, "click", func);
  },
  //--------------------------------------------------
  ...
  //--------------------------------------------------
  scrollTop: function () {
    return util.isIE() ? ((document.documentElement && document.documentElement.scrollTop) || document.body.scrollTop) : window.scrollY;
  },
  //--------------------------------------------------
  isIE: function () {
    if (util.ie === undefined) {
      util.ie = /rv:/i.test(navigator.userAgent) || /msie/i.test(navigator.userAgent) || /edge/i.test(navigator.userAgent);
    }
    return util.ie;
  },
  //--------------------------------------------------
